            ...
            <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                <div class="sm:flex sm:items-start">
                    <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                        ...
                        <div class="mt-2">
                            <p class="text-sm text-gray-500">Masukkan informasi user baru yang akan ditambahkan ke
                                sistem.</p>

                            <form id="addUserForm" method="POST" action="{{ route('superadmin.store.user') }}"
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    <div>
                                        <label for="name"
                                            class="block text-sm font-medium text-gray-700">Pengunna</label>
