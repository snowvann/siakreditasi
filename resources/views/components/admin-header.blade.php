        ...
        <div class="flex h-16 sm:h-18 items-center justify-between">
            ...
            <div class="flex items-center gap-3 sm:gap-4">
                ...
                <div class="flex items-center gap-2 sm:gap-3">
                    <img src="{{ asset('logo/logopolinema.png') }}" alt="Logo Polinema"
                        class="h-8 sm:h-10 w-auto transition-all duration-200 hover:scale-105">
                    <img src="{{ asset('logo/logojti.png') }}" alt="Logo JTI"
                        class="h-8 sm:h-10 w-auto transition-all duration-200 hover:scale-105">
                </div>
                ...
                <div class="hidden sm:block border-l border-gray-300 pl-3 sm:pl-4">
                    <h1
                        class="text-lg sm:text-xl font-bold bg-gradient-to-r from-[#95A0E8] to-[#7548BE] bg-clip-text text-transparent tracking-tight">
                        SIAKREDITASI
                    </h1>
                ...
                <div class="block sm:hidden">
                    <h1
                        class="text-sm font-bold bg-gradient-to-r from-[#95A0E8] to-[#7548BE] bg-clip-text text-transparent">
                        SIAKREDITASI</h1>
            ...
            <div class="flex items-center gap-2 sm:gap-4">
                ...
                <div x-data="{ open: false }" class="relative">
                    ...
                    <button @click="open = !open"
                        ...
                        <!-- Avatar -->
                        <div
                            class="h-9 w-9 sm:h-10 sm:w-10 rounded-full overflow-hidden border-2 border-gray-200 shadow-sm ring-2 ring-white">
                            @if (auth()->user()->photo)
                                <img src="{{ asset('storage/photos/' . auth()->user()->photo) }}" alt="User Photo"
                                    class="object-cover w-full h-full">
                            @else
                                <div
                                    class="h-full w-full flex items-center justify-center bg-gradient-to-br from-blue-500 to-purple-600 text-white font-semibold text-sm">
                    ...
                    <div x-show="open" @click.away="open = false" x-transition:enter="transition ease-out duration-200"
                        ...
                        <!-- Header -->
                        <div
                            class="px-4 sm:px-6 py-4 bg-gradient-to-r from-blue-50 to-purple-50 border-b border-gray-100">
                            <div class="flex items-center gap-3">
                                <div class="h-12 w-12 rounded-full overflow-hidden border-2 border-white shadow-sm">
                                    ...
                                    @else
                                        <div
                                            class="h-full w-full flex items-center justify-center bg-gradient-to-br from-blue-500 to-purple-600 text-white font-semibold">
                                            {{ strtoupper(substr(auth()->user()->name, 0, 2)) }}
                                        </div>
                                    @endif
                                </div>
                        ...
                        <div class="py-2">
                            <a href="{{ route('admin') }}"
                                ...
                                <div
                                    class="flex items-center justify-center w-8 h-8 rounded-lg bg-gray-100 group-hover:bg-blue-100 transition-colors duration-150 mr-3">
                                    <svg xmlns="http://www.w3.org/2000/svg"
                                        class="w-4 h-4 text-gray-600 group-hover:text-blue-600" fill="none"
                            ...
                            <form method="POST" action="{{ route('logout') }}">
                                ...
                                <button type="submit"
                                    ...
                                    <div
                                        class="flex items-center justify-center w-8 h-8 rounded-lg bg-red-100 group-hover:bg-red-200 transition-colors duration-150 mr-3">
                                        <!-- Ikon baru di sini -->
                                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-red-600"
                                            viewBox="0 0 24 24" fill="currentColor">
                                            <path d="M10 17L15 12L10 7V10H3V14H10V17Z" />
                                            <path
                                                d="M19 3H11C10.45 3 10 3.45 10 4V7H12V5H18V19H12V17H10V20C10 20.55 10.45 21 11 21H19C19.55 21 20 20.55 20 20V4C20 3.45 19.55 3 19 3Z" />
                                        </svg>
                                    </div>
                                    <div class="text-left">
