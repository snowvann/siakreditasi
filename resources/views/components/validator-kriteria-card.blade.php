        ...
        <div class="flex-1">
            ...
            <div class="p-3 pt-0 flex justify-between items-center">
                <a href="{{ route('validator.kriteria.show', $kriteria['id']) }}" 
                   class="inline-flex items-center justify-center rounded-md text-sm font-medium bg-gradient-to-r from-[#95A0E8] to-[#7548BE] text-white hover:from-[#8a95e3] hover:to-[#6d42b8] focus:outline-none focus:ring-2 focus:ring-purple-400 focus:ring-offset-2 transition-all duration-200 h-9 px-3 shadow-sm hover:shadow-md">
                    Lihat Detail
