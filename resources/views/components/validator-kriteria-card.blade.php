        ...
        <div class="flex-1">
            ...
            <div class="p-3 pt-0 flex justify-between items-center">
                <a href="{{ route('validator.kriteria.show', $kriteria['id']) }}" 
                   class="inline-flex items-center justify-center rounded-md text-sm font-medium bg-gradient-to-r from-[#7C4585] to-[#d3394c] text-white hover:from-[#7C4585] hover:to-[#d3394c] focus:outline-none focus:ring-2 focus:ring-purple-400 focus:ring-offset-2 transition-all duration-200 h-9 px-3 shadow-sm hover:shadow-md">
                    Lihat Detail
